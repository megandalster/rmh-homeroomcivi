...
class testdbRooms extends UnitTestCase{
	function testdbRoomsModule(){
		...
		$room2 = new Room("223", "Q", "2", "n", "reserved", null, "");
		...
		$this->assertFalse($room1->book_me("13-07-26Alison2076942604"));
		// but can book a clean room
		$this->assertTrue($room2->book_me("13-07-26Alison2076942604"));
		...
		$this->assertTrue($room2->unbook_me("13-07-26Alison2076942604"));
