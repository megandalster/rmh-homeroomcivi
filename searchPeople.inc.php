<?PHP
	...
	echo('<table><tr><td>First Name:</td><td><input type="text" name="s_first_name" value="'.$_POST['s_first_name'].'"></td></tr>');
	echo('<tr><td>Last Name:</td><td><input type="text" name="s_last_name" value="'.$_POST['s_last_name'].'"></td></tr>');
	echo('<tr><td>E-mail:</td><td><input type="text" name="s_email" value="'.$_POST['s_email'].'"></td></tr>');
	echo('<tr><td>Patient Name:</td><td><input type="text" name="s_patient_name" value="'.$_POST['s_patient_name'].'"></td></tr>');
    ...
    echo('<tr><td>Type:</td><td><select name="s_type">' .
			...
			'<option value="socialworker" '.($_POST["s_type"]=="socialworker"?"selected":"").'>socialworker</option>' .
